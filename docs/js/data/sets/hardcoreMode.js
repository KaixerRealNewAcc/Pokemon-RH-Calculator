var SETDEX_SV = {
    //this is a template for adding new sets, do not use this as a set.
   "Missingno": {
        "Template": {
        "level": 1,
        "ability": "",
  ...
  "Charizard-Mega-Y": {
     "Route 22 Rival #2 Charmander": {
        ...
        "nature":"Timid",
        "item":"Chardizardite Y",
        "index":522,
      },
  },
  "Bulbasaur": {
    "Rival Route 22 #1 Bulbasaur": {
        "level": 15,
        "ability": "Overgrow",
        "moves":[
            "Sludge",
  ...
  "Cloyster": {
    ...
    "Leader Pryce Team 3": {
     ...
     "Cerulean Cave Black Belt Ketchup": {
        "level": 81,
        "ability": "Skill Link",
        "moves":[
            "Liquidation",
